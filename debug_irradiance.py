...
from battery_management.sensor import calculate_panel_irradiance, calculate_solar_position
...
def test_irradiance():
    ...
    print(f"Panel tilt: {panel_tilt}°, Orientation: {panel_orientation}° (South-facing)")
    print()
    ...
    for test_time in test_times:
        ...
        print(f"  Solar position - Elevation: {elevation:.1f}°, Azimuth: {azimuth:.1f}°")
